    ...
    function(a, e, t) {
        ...
        t(".search-list-main").mouseenter((function() {
                ...
                if (t("ul.search-list li").remove(), t(this).parent().hasClass("bookmark-input") && (n = !0), "" != e) {
                    ...
                    t.getJSON(r + "data/" + p + ".json", (function(a) {
                        ...
                        for (m = 0; m < a.listItems.length; m++) {
                            if (!0 === n) {
                                s = "";
                                for (p = t("ul.nav.navbar-nav.bookmark-icons li"), v = 0; v < p.length; v++) s = a.listItems[m].name === p[v].firstChild.dataset.originalTitle ? " text-warning" : "";
                                h = feather.icons.star.toSvg({
                                    class: "bookmark-icon float-right" + s
                                })
                            }
            ...
            if (a.stopPropagation(), t(this).hasClass("text-warning")) {
                ...
                for (var e = t("ul.nav.navbar-nav.bookmark-icons li"), s = 0; s < e.length; s++) e[s].firstChild.dataset.originalTitle == t(this).parent()[0].innerText && e[s].remove();
                a.preventDefault()
            } else {
