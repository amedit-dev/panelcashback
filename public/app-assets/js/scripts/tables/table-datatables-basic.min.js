$((function() {
   ...
   // console.log(path + '/api?date='+ date );
    ...
    $("button").click(function(){
        ...
        console.log(imgUrl);
        $("#screenshootarea").html("<img src='" + imgUrl + "' alt='description' />");
